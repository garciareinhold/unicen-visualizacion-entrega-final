                ...
                complete: (function () {
                  if(this.plane.pickedLife && this.plane.lives.length<=6){
                    ...
                    $(oneUp).css({
                      width:"107px",
                      height:"52px",
                      "background-image": "url(assets/game-images/1up.png)",
                      top: "45%",
                      "margin-left": "40%"
                    })
                    console.log(oneUp);
...
Game.prototype.setOptionsUser = function (optionsUser) {
  ...
  if(this.optionsUser.music.music=="ON"){
    this.music = new Audio("assets/audios/music.mp3");
    this.music.loop=true;
  }
  if(this.optionsUser.music.sound=="ON"){
    this.airTrafficInspector.explotionEffect = new Audio("assets/audios/explotion.mp3");
    this.airTrafficInspector.lifeUp = new Audio("assets/audios/lifeUp.mp3");
  }
};
